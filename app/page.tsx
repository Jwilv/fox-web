  ...
  return (
    <main>
      <div className="bg-black  overflow-hidden relative">
        <div className="wallpaper home flex items-start justify-center" />
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center flex-col">
          <Image
            src={logo}
            alt="logo"
            width={250}
            height={250}
          />
          <h2 className="text-white font-bold text-3xl md:text-5xl mb-5">Fox Stealth Group</h2>
          <div className="card">
            <a className="social-link3" href="https://discord.gg/JE55anXBWq" target="_blank">
